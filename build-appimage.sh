...
"$APPIMAGE_TOOL" --appimage-extract-and-run "$APPDIR" "${PROJECT_DIR}/Minecraft_GDK_Launcher-v2.4.1-x86_64.AppImage"

echo
echo "=========================================="
echo " AppImage build complete!"
echo " Output path: ${PROJECT_DIR}/Minecraft_GDK_Launcher-v2.4.1-x86_64.AppImage"
echo "=========================================="
