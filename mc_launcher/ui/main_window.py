...
class LauncherWindow(Adw.ApplicationWindow):
    def __init__(self, app):
        ...
        icon_path = _os.path.join(_SD, "assets", "icon.png")
        ...
        gh_btn = Gtk.Button(label=_t("btn_open"))
        gh_btn.add_css_class("pill")
        gh_btn.connect("clicked", lambda *_: self._open_uri("https://github.com/mdevlopm/mc-gdk-launcher-gui"))
        ...
        dc_btn = Gtk.Button(label=_t("btn_open"))
        dc_btn.add_css_class("pill")
        dc_btn.connect("clicked", lambda *_: self._open_uri("https://discord.com/"))
        dc_row.add_suffix(dc_btn)
