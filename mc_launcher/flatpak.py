...
def wrap_flatpak_cmd(cmd, env=None, cwd=None):
    ...
    if env:
        ...
        force_vars = {"WINEDLLOVERRIDES", "WINEPREFIX", "PROTON_LOG", "STEAM_COMPAT_DATA_PATH", "STEAM_COMPAT_CLIENT_INSTALL_PATH", "SDL_VIDEODRIVER", "GDK_BACKEND", "VKD3D_CONFIG", "XDG_DATA_HOME", "XDG_CONFIG_HOME", "XDG_STATE_HOME"}
